...
exports.incrementAsync = toolkit_1.createAsyncThunk('counter/fetchCount', function (amount) { return __awaiter(void 0, void 0, void 0, function () {
    var response;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, counterAPI_1.fetchCount(amount)];
            case 1:
                response = _a.sent();
...
exports.counterSlice = toolkit_1.createSlice({
    ...
    extraReducers: function (builder) {
        builder
            .addCase(exports.incrementAsync.pending, function (state) {
            state.status = 'loading';
        })
            .addCase(exports.incrementAsync.fulfilled, function (state, action) {
            state.status = 'idle';
            state.value += action.payload;
        })
            .addCase(exports.incrementAsync.rejected, function (state) {
            state.status = 'failed';
        });
    }
});
...
exports.selectCount = function (state) { return state.counter.value; };
// We can also write thunks by hand, which may contain both sync and async logic.
// Here's an example of conditionally dispatching actions based on current state.
exports.incrementIfOdd = function (amount) {
    return function (dispatch, getState) {
        var currentValue = exports.selectCount(getState());
        if (currentValue % 2 === 1) {
